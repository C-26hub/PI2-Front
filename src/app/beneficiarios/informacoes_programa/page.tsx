  ...
  <div>
    ...
    <div className="relative">
      <select
        ...
        value={value}
        onChange={onChange}
          className="block w-full h-10 pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm rounded-md appearance-none bg-white"
      >
...
const CadastroInformacoesPrograma = () => {
  ...
  const handleSave = (): void => {
    ...
    // Finaliza o cadastro e redireciona para a página inicial ou lista de beneficiários
    router.push("/"); 
  };
  ...
  const handleBack = (): void => {
    ...
    router.push("/beneficiarios/contato");
  };
      ...
      <main className="flex-1 flex items-center justify-center bg-[url('/images/login-bg.jpg')] bg-cover bg-center p-4">
        <div className="w-full max-w-3xl p-8 bg-white shadow-lg rounded-lg">
          ...
          <div className="flex justify-between items-center mt-8">
            <button 
              onClick={(): void => router.push("/beneficiarios")} // Cancela e volta para a 1ª etapa (Informações Pessoais)
