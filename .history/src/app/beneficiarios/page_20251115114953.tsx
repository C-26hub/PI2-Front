 ...
 * 4. Remoção do componente Logo separado e integração direta do logo/texto no Header para melhor controle de alinhamento.
 * 5. A classe 'h-full' nos links de navegação garante que eles ocupem toda a altura do header, permitindo que o 'inline-flex items-center' os centralize verticalmente.
 */
...
// Exportando o componente auxiliar ProfileDropdown
