 ...
 * 4. A classe 'h-full' nos links de navegação garante que eles ocupem toda a altura do header, permitindo que o 'inline-flex items-center' os centralize verticalmente.
 * 5. CORREÇÃO DO ERRO DE EXPORTAÇÃO: Alterado de volta para 'export function Header()' para ser uma exportação nomeada, conforme a importação original do usuário.
 */
export function Header() { // Exportação nomeada (corrigida)
  return (
