...
// --- Componente Principal da Página (CadastroOrigemDocumentacao) ---
// Segunda etapa do cadastro de Lote de Sementes: Origem e Documentação
const CadastroOrigemDocumentacao = () => {
  ...
  const handleSave = (): void => {
    console.log("Cadastro de Lote de Sementes Finalizado:", { associacao, tecnicoResponsavel, statusInicial });
    // Finaliza o cadastro e redireciona para a lista de lotes de sementes
    router.push("/ciclo-sementes"); 
  };

  // Simula a volta para a página anterior (CadastroLoteSementes - Informações Básicas)
  const handleBack = (): void => {
    // Volta para a 1ª etapa do lote de sementes
    router.push("/ciclo-sementes/cadastro"); 
  };
        ...
        <div className="w-full max-w-3xl p-8 bg-white shadow-lg rounded-lg">
          ...
          <div className="flex items-center mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Origem e Documentação</p>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center mt-8">
            <button 
              onClick={(): void => router.push("/ciclo-sementes")} // Cancela e volta para a lista de lotes
...
export default CadastroOrigemDocumentacao;